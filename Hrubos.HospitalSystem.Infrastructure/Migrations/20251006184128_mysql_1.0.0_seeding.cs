    ...
    public partial class mysql_100_seeding : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Attachment", "Description", "ExaminationId", "Values" },
                values: new object[,]
                {
                    { 1, null, "vše v pořádku", 1, "TK: 120/80, Puls: 72" },
                    { 2, null, "lehká anémie", 2, "Hemoglobin: 110 g/l, Hct: 33%" },
                    { 3, "cloub_knee_xray.jpg", "artritida kolene", 3, "RTG: mírná artritida, rentgenový snímek v příloze" }
                });
